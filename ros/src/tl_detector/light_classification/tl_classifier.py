...
class TLClassifier(object):
    def __init__(self, model_filename):
        ...
        # path_to_ckpt = current_directory + '/trafficlight_model_sim/frozen_inference_graph.pb'
        path_to_ckpt = current_directory + '/trafficlight_model_sim/' + model_filename

        path_to_labels = current_directory + '/label_map.pbtxt'
        num_classes = 4
